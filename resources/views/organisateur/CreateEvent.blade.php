<x-organisateur-layout>
    <div class="container mx-auto p-8 bg-white rounded shadow-lg mt-6">
        ...
        <form action="{{ route('Event.store') }}" method="post" enctype="multipart/form-data" class="max-w-md mx-auto">
            ...
            <div class="mb-4">
                <label for="image" class="block text-gray-700 text-sm font-bold mb-2">Image Event:</label>
                <input type="file" name="image" id="image" class="form-input w-full px-4 py-2 border-2 border-gray-300 rounded focus:outline-none focus:border-blue-500" >
            </div>
